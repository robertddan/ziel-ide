...
class Home {
    ...
    public static function home_init()
    {
        ...
        $aPage['content'] .= <<<EOD
<style>
body { font-family: 'Calibri', sans-serif; display: flex; flex-direction: column; min-height: 100vh; margin: 0; padding: 0; } header { flex: 0 0 0; background-color: #C14F4F; } main { flex: 1; display: flex; background-color: #699EBD; height: 86%; } footer { flex: 0 0 40px; background-color: #C14F4F; text-align: center; } .left, .right { flex: 0 2 25%; background-color: #C28282; height: 100%; overflow: hidden; } .middle { flex: 1 1 75%; padding-left: 50px; } .loader { border: 16px solid #f3f3f3; border-top: 16px solid #3498db; border-radius: 50%; width: 60px; height: 60px; animation: spin 2s linear infinite; position: absolute; top: 50%; left: 50%; margin-left: -20px; margin-top: -20px; } @keyframes spin { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } } .hidden { display: none; } /*@font-face { font-family: "Fira Code"; src: url("/fonts/FiraCode-Regular.ttf"); }*/ textarea { font-size: 16px; height: 100%; width: 100%; resize: none; border: none; } textarea:focus { outline: none; border: none; }
...
#file-explorer > div { padding-bottom: 220px; } #file-explorer { overflow: scroll; height: 100%; scrollbar-width: thin; background-color: lightyellow; } #file-explorer div { display: flex; flex-direction: column; } #file-explorer li { list-style-type: none; } #file-explorer a { text-decoration: none; color: #303030; } #file-explorer a:hover { } #file-explorer span { background-color: lightyellow; cursor: pointer; /*border-top: 1px solid gray;*/ } #file-explorer span:hover { background-color: bisque; } .file-explorer-directory { padding: 10px; } .file-explorer-directory:hover { } .file-explorer-file { padding: 10px; } .file-explorer-directory + div { margin-left: 14px; border-left: 1px solid #e0e0e0; } .file-explorer-directory:hover { } .file-explorer div span:nth-last-child(){ border-bottom: 1px solid gray; }
